...
Path = [r"C:\Users\nazeh\Downloads\Data_U-net\Dataset_BUSI_with_GT\Input_MRI",
        r"C:\Users\nazeh\Downloads\Data_U-net\Dataset_BUSI_with_GT\Input_CT"]



# Convert lists to numpy arrays and add channel dimension
X = np.array(filters_used)
y = np.array(groundtruths)

X = np.expand_dims(X, axis=-1)  # Add channel dimension to X
...
model.fit(X_train, y_train, validation_data=(X_val, y_val), epochs=40, verbose=1)